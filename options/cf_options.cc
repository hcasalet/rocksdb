    ...
    cf_immutable_options_type_info = {
        ...
        {"compacting_column_family_num_levels",
         {offsetof(struct ImmutableCFOptions, compacting_column_family_num_levels), OptionType::kInt,
          OptionVerificationType::kNormal, OptionTypeFlags::kNone}},
        {"compacting_level_within_column_family_group",
         {offsetof(struct ImmutableCFOptions, compacting_level_within_column_family_group), OptionType::kInt,
          OptionVerificationType::kNormal, OptionTypeFlags::kNone}},  
        {"num_columns",
         {offsetof(struct ImmutableCFOptions, num_columns), OptionType::kInt,
          OptionVerificationType::kNormal, OptionTypeFlags::kNone}},
        {"transform_type",
         {offsetof(struct ImmutableCFOptions, transform_type), OptionType::kInt,
          OptionVerificationType::kNormal, OptionTypeFlags::kNone}},  
        {"translevel",
...
ImmutableCFOptions::ImmutableCFOptions(const ColumnFamilyOptions& cf_options)
    : compaction_style(cf_options.compaction_style),
      ...
      transform_type(cf_options.transform_type),
