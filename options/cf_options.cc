    ...
    cf_immutable_options_type_info = {
        ...
        {"transformer_type",
         {offsetof(struct ImmutableCFOptions, transformer_type), OptionType::kInt,
          OptionVerificationType::kNormal, OptionTypeFlags::kNone}},
        {"input_data_type",
         {offsetof(struct ImmutableCFOptions, input_data_type), OptionType::kInt,
          OptionVerificationType::kNormal, OptionTypeFlags::kNone}},
        {"output_data_type",
         {offsetof(struct ImmutableCFOptions, output_data_type), OptionType::kInt,
          OptionVerificationType::kNormal, OptionTypeFlags::kNone}},
        {"bloom_locality",
...
ImmutableCFOptions::ImmutableCFOptions(const ColumnFamilyOptions& cf_options)
    : compaction_style(cf_options.compaction_style),
      ...
      column_data_type(cf_options.column_data_type),
